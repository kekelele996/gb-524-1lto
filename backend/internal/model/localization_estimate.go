...
type LocalizationEstimate struct {
	...
	ResidualsJSON          datatypes.JSON `json:"residuals_json" gorm:"type:jsonb;not null;default:'[]'"`
	InputSnapshotJSON      datatypes.JSON `json:"input_snapshot_json" gorm:"type:jsonb;not null;default:'[]'"`
